...
document.addEventListener("visibilitychange", function () {
  if (document.hidden) {
    window.backupRainCount = window.rainCount;
    window.rainCount = "none";
  } else {
    window.rainCount = window.backupRainCount;
  }
});
...
function newDrop() {
  ...
  for (let x = 0; x < rainCountObject[window.rainCount]; x++) {
